 ...
 */
export type IParticipant = chevre.person.IPerson | chevre.seller.ISeller;
 ...
 * 追加属性インターフェース
 */
export type IAdditionalProperty = chevre.propertyValue.IPropertyValue<string>[];
...
export interface IDynamicAttributes {
     ...
     * アクション状態
     */
    actionStatus: chevre.actionStatusType;
    /**
     * 開始日時
     */
    startDate: Date;
...
export interface ISearchConditions<T extends ActionType> {
    ...
    typeOf?: T;
    actionStatusTypes?: chevre.actionStatusType[];
    startFrom?: Date;
    startThrough?: Date;
    agent?: {
        typeOf?: {
